...
export interface Result { id:string; workspace_id:string; assessment_id:string; enrollment_id:string; class_id:string; state:ResultState; score:number|null; created_at:string; updated_at:string; }
export interface Attempt { id:string; workspace_id:string; result_id:string; attempt_kind:AttemptKind; sequence_no:number; raw_score:number|null; evidence:Record<string, unknown>; recorded_at:string; created_at:string; }

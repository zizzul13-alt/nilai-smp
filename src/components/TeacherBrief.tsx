...
export function TeacherBrief({client,userId,workspaceId}:{client:SupabaseClient;userId:string;workspaceId:string}){
  ...
  return<section className="today-shell teacher-brief-shell">
    <header><p className="eyebrow">F2 · Brief Guru</p><h1>{narrative.headline}</h1><p className="muted">Ringkasan deterministik dari data kanonik dengan narasi AI opsional. AI tidak mengubah nilai, Meeting, laporan, atau dokumen; bila provider gagal, brief deterministik tetap dipakai.</p></header>
